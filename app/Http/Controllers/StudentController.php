...
class StudentController extends Controller
{
    ...
    public function store(Request $request)
    {
        //
            ...
            return redirect()->route('students.index')->with('success', 'Student added succsesfully.');
    ...
    {
        // bo sung phan xac nhan xoa 
        $student->delete();
        return redirect()->route('students.index')->with('success','Student Data deleted successfull');
